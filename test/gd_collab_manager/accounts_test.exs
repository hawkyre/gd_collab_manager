defmodule GdCollabManager.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates minimum and maximum values for username for security" do
      too_long = String.duplicate("d", 25)
      too_short = String.duplicate("d", 2)
      ...
      {:error, changeset} = Accounts.register_user(%{username: too_short})
